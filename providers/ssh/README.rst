...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.3.4/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.3.4/changelog.html>`_.
