        ...
        "config": {
            ...
            "aws_lambda_executor": {
                ...
                "options": {
                    ...
                    "region_name": {
                        "description": "The name of the AWS Region where Amazon Lambda is configured. Required.\n",
                        "version_added": "9.7.0",
                        "type": "string",
                        "example": "us-east-1",
                        "default": None,
                    ...
                    "max_run_task_attempts": {
                        "description": "The maximum number of times the Lambda Executor should attempt to run a task.\n",
                        "version_added": "9.7.0",
                        "type": "integer",
                        "example": "3",
                        "default": "3",
                    ...
                    "dead_letter_queue_url": {
                        "description": "The name of the SQS dead letter queue to use for the Lambda function.\nThe Lambda executor will poll this queue for timeout/exception results of the lambda function.\n",
                        "version_added": "9.7.0",
                        "type": "string",
                        "example": "airflow-lambda-executor-function",
                        "default": None,
