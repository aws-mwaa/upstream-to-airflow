...
.. note::
    The import path for :class:`~airflow.sdk.definitions.callback.AsyncCallback` was changed in Airflow 3.2.
...
:class:`~airflow.sdk.definitions.callback.AsyncCallback`, with support coming soon for
:class:`~airflow.sdk.definitions.callback.SyncCallback`.
