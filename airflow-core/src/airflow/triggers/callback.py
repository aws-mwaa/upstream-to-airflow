    ...
    async def run(self) -> AsyncIterator[TriggerEvent]:
        try:
            ...
            if isinstance(e, ImportError):
                message = "Failed to import this callback on the triggerer"
            elif isinstance(e, TypeError) and "await" in str(e):
                message = "Failed to run this callback because it is not awaitable"
            else:
                message = "An error occurred during execution of this callback"
