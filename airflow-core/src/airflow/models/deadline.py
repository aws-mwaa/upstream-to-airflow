...
import uuid6
from sqlalchemy import Boolean, Column, ForeignKey, Index, Integer, and_, func, select, text
...
class Deadline(Base):
    ...
    def __init__(
        ...
        self.missed = False
        self.callback = CallbackModel.create_from_sdk_def(callback)
    ...
    def handle_miss(self, session: Session):
        ...
        if isinstance(self.callback, TriggererCallback):
            self.callback.data["kwargs"] = (self.callback.data["kwargs"] or {}) | {
